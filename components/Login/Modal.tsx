...
const LoginModal: FunctionComponent<ModalProps> = (props: ModalProps) => {
  return (
    <React.Fragment>
      <Dialog
        fullWidth={true}
      ...
      >
        <div className="login">
          ...
          <div className="login__modal">
            <div className="login__modal__title">
              Đăng nhập Nội thất Dodo
            </div>
            <div className="login__modal__description">
            ...
            <div className="login__modal__block">
              <Button className="login__modal__block__google" href={googleLogin}>
                <svg viewBox="0 0 533.5 544.3">
                  <g>
                    <path className="st0" d="M533.5,278.4c0-18.5-1.5-37.1-4.7-55.3H272.1v104.8h147c-6.1,33.8-25.7,63.7-54.4,82.7v68h87.7
		C503.9,431.2,533.5,361.2,533.5,278.4z"/>
                    <path className="st1" d="M272.1,544.3c73.4,0,135.3-24.1,180.4-65.7l-87.7-68c-24.4,16.6-55.9,26-92.6,26c-71,0-131.2-47.9-152.8-112.3
		H28.9v70.1C75.1,486.3,169.2,544.3,272.1,544.3z"/>
                    ...
                    <path className="st3" d="M272.1,107.7c38.8-0.6,76.3,14,104.4,40.8l0,0l77.7-77.7C405,24.6,339.7-0.8,272.1,0C169.2,0,75.1,58,28.9,150
